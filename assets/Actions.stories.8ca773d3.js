...
`)),e("h2",null,"Props"),e(t,{of:m,sort:"requiredFirst",mdxType:"ArgsTable"}))}a(d,"MDXContent");d.isMDXComponent=!0;const R=a(()=>{throw new Error("Docs-only story")},"__page");R.parameters={docsOnly:!0};const i={title:"Components/Actions",includeStories:["__page"]},T={};i.parameters=i.parameters||{};i.parameters.docs={...i.parameters.docs||{},page:()=>e(u,{mdxStoryNameToKey:T,mdxComponentAnnotations:i},e(d,null))};const U=["__page"];export{U as __namedExportsOrder,R as __page,i as default};
//# sourceMappingURL=Actions.stories.8ca773d3.js.map
