...
`)),e("h2",null,"Props"),e(n,{of:h,sort:"requiredFirst",mdxType:"ArgsTable"}))}c(A,"MDXContent");A.isMDXComponent=!0;const E=c(()=>{throw new Error("Docs-only story")},"__page");E.parameters={docsOnly:!0};const a={title:"Components/actions/Actions(basic)",id:"components-actions-basic",includeStories:["__page"]},T={};a.parameters=a.parameters||{};a.parameters.docs={...a.parameters.docs||{},page:()=>e(f,{mdxStoryNameToKey:T,mdxComponentAnnotations:a},e(A,null))};const D=["__page"];export{D as __namedExportsOrder,E as __page,a as default};
//# sourceMappingURL=Actions.stories.8697125d.js.map
