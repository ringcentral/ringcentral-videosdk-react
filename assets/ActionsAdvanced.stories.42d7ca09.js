...
`)),e("h2",null,"Props"),e(o,{of:g,sort:"requiredFirst",mdxType:"ArgsTable"}))}r(h,"MDXContent");h.isMDXComponent=!0;const x=r(()=>{throw new Error("Docs-only story")},"__page");x.parameters={docsOnly:!0};const i={title:"Components/actions/Actions(advanced)",id:"components-actions-advanced",includeStories:["__page"]},N={};i.parameters=i.parameters||{};i.parameters.docs={...i.parameters.docs||{},page:()=>e(v,{mdxStoryNameToKey:N,mdxComponentAnnotations:i},e(h,null))};const W=["__page"];export{W as __namedExportsOrder,x as __page,i as default};
//# sourceMappingURL=ActionsAdvanced.stories.42d7ca09.js.map
