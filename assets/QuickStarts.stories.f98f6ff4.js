...
`)),e("h2",null,"Step 3: Meeting View is rendered successfully"),e("div",{style:{display:"flex",width:"100%",height:"300px",flexDirection:"column",boxSizing:"border-box"}},e(m,{layout:g.gallery,style:{flex:1},mdxType:"GalleryLayout"}),e(u,{leftActions:[e(y,{key:"meeting-info-action",mdxType:"MeetingInfoAction"})],centerActions:[e(v,{key:"audio-action",mdxType:"AudioAction"}),e(f,{key:"video-action",mdxType:"VideoAction"}),e(A,{key:"participant-action",mdxType:"ParticipantAction"}),e(h,{key:"chat-action",mdxType:"ChatAction"}),e(x,{key:"record-action",mdxType:"RecordAction"}),e(E,{key:"leave-action",mdxType:"LeaveAction"})],rightActions:[e(w,{key:"logo-icon",text:"demo",mdxType:"LogoIcon"})],mdxType:"ActionBar"})))}o(s,"MDXContent");s.isMDXComponent=!0;const k=o(()=>{throw new Error("Docs-only story")},"__page");k.parameters={docsOnly:!0};const i={title:"Quick Starts",includeStories:["__page"]},S={};i.parameters=i.parameters||{};i.parameters.docs={...i.parameters.docs||{},page:()=>e(d,{mdxStoryNameToKey:S,mdxComponentAnnotations:i},e(s,null))};const _=["__page"];export{_ as __namedExportsOrder,k as __page,i as default};
//# sourceMappingURL=QuickStarts.stories.f98f6ff4.js.map
